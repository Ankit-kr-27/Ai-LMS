...
const ViewLectures = () => {
  ...
  return (
    <div className='min-h-screen bg-gray-50 p-6 flex flex-col md:flex-row gap-6'>
      ...
      <div className='mb-6'>
        <h2 className='text-2xl font-bold flex items-center justify-start gap-[20px] text-gray-800'><FaArrowLeft className='text-black w-[22px] cursor-pointer' onClick={() => navigate("/")} />{selectedCourse?.title}</h2>
      ...
      <h2 className='text-xl font-bold text-gray-800 mb-4'>All lectures</h2>
      <div className='flex flex-col gap-3 mb-6'>
        ...
        (selectedCourse?.lectures?.map((lecture, index) => (
          <button key={index} onClick={() => setSelectedLecture(lecture)} className={`flex items-center justify-between p-3 rounded-lg border transition text-left ${
            ...
            <h2 className='text-md font-semibold text-gray-800'>{lecture.lectureTitle}</h2>
      ...
      <div className='mt-4 border-t pt-4'>
        <h3 className='text-md font-semibold text-gray-700 mb-3'>About the instructor</h3>
